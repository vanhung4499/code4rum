...
/**
 * Encapsulation of post stream data to avoid premature consumption of request parameters due to logging
 *
 * TODO: Encapsulation of request parameters to avoid consumption after input stream read once
 */
