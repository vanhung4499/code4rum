...
public class HttpRequestHelper {
    ...
    /**
     * Scheduled task to refresh Rest template
     */
     ...
     * @param bytes     Uploaded file stream
     * @return
     */
    public static String upload(String url, String paramName, String fileName, byte[] bytes) {
        ...
        // Set request body, note that it is LinkedMultiValueMap
        ...
        // Use HttpEntity to encapsulate the entire request message
