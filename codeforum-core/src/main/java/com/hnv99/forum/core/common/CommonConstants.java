package com.hnv99.forum.core.common;
...
public class CommonConstants {
    ...
    public static final String CATEGORY_BACK_END        = "Back End";
    public static final String CATEGORY_FRONT_END       = "Front End";
    public static final String CATEGORY_ANDROID         = "Android";
    public static final String CATEGORY_IOS             = "IOS";
    public static final String CATEGORY_BIG_DATA        = "Big Data";
    public static final String CATEGORY_INTELLIGENCE    = "Artificial Intelligence";
    public static final String CATEGORY_CODE_LIFE       = "Code Life";
    public static final String CATEGORY_TOOL            = "Development Tools";
    public static final String CATEGORY_READ            = "Reading";
    ...
    public static final Map<String, List<String>> HOMEPAGE_TOP_PIC_MAP = new HashMap<String, List<String>>() {
        {
            ...
            put(CATEGORY_BACK_END, new ArrayList<String>() {
                {
